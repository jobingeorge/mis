                        ...
                        <div class="panel-group">
                            <div class="panel panel-default">
                                ...
                                <div id="addnewsurpriseInspection" class="panel-collapse collapse in">
                                    ...
                                    @if(isset($data['formType']) && $data['formType']=='create')
                                         <form role="form" action="{{route('md-fi-surprise-inspection.store')}}" id="surpriseInspectionForm" name="surpriseInspectionForm" method="POST" class="row">
                                          @csrf
                                         @endif
                                         @if(isset($data['formType']) && $data['formType']=='edit')
                                        ...
                                        @method('PUT')
                                         ...
                                         @endif
                                         @if(isset($data['formType']) && $data['formType']=='show')
                                         <form role="form" action="#" id="surpriseInspectionForm" name="surpriseInspectionForm" method="POST" class="row">
                                         @csrf
                                         @endif
                                            ...
                                            @php
                                                $style  =   '';
                                            @endphp
                                            @if(isset($data['inspection'][0]['inspection_type']) && ( $data['inspection'][0]['inspection_type']=='combined' || $data['inspection'][0]['inspection_type']=='special_drive') )
                                                @php
                                                    $style  =   'style=display:block;';
                                                @endphp
                                            @endif
                                            <div class="col-lg-4 col-md-6 col-xs-12 hide-box ins-detail-sec" {{$style}} >
                                                <div class="form-group">
                                                    <label>Members</label>
