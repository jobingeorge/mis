            ...
            <div class="row">
                <div class="col-lg-12">
                     ...
                     <!-- @if(isset($data['formType']) && $data['formType']=='create')
                      <h3 class="page-header">MASTER DATA SURPRISE INSPECTION CREATE</h3>
                    @endif
                   @if(isset($data['formType']) && $data['formType']=='edit')
                      <h1 class="page-header">Edit Surprise Inspection</h1>
                    @endif
                    @if(isset($data['formType']) && $data['formType']=='show')
                      <h1 class="page-header"> Surprise Inspection Details</h1>
                    @endif -->
                     <h1 class="page-header">Edit Surprise Inspection</h1>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                        <div class="panel-group">
                            <div class="panel panel-default">
                                ...
                                <!-- @if(isset($data['formType']) && $data['formType']=='create')
                                  <h5>Add New Surprise Inspection</h5p>
                                @endif
                                 @if(isset($data['formType']) && $data['formType']=='edit')
                                  <h5>Edit Surprise Inspection</h5p>
                                @endif
                                 @if(isset($data['formType']) && $data['formType']=='show')
                                  <h5>Surprise Inspection Details</h5p>
                                @endif -->
                                <h5>Edit Surprise Inspection</h5p>
                                </div>
                                <div id="addnewsurpriseInspection" class="panel-collapse collapse in">
                                    ...
                                    <!-- end display form validation errors -->
                                         ...
                                         <form role="form" action="{{route('md-fi-surprise-inspection.update',$data['inspection'][0]['id'])}}" id="surpriseInspectionForm" name="surpriseInspectionForm" method="POST" class="row">
                                                @method('PUT')
                                                @csrf
                                            ...
                                            <div class="col-lg-4 col-md-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <select type="text" name="time_to" id="time_to" class="form-control" placeholder="to">
                                                        ...
                                                        <option {{(isset($data['inspection'][0]['time_to']) && $data['inspection'][0]['time_to']=='12:00AM'?'selected':'')}} value="12:00PM">12:00PM</option>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-xs-12">
                                                 <div class="form-group">
                                                    <label>Surprise Inspection Type</label>
                                                    <select type="text" name="inspection_type" id="inspection_type" class="form-control" placeholder="compliance type">
                                                        <option value="">Select Inspection Type </option>
                                                        <option {{(isset($data['inspection'][0]['inspection_type']) && $data['inspection'][0]['inspection_type']=='individual'?'selected':'')}} value="individual">Individual</option>
                                                        <option {{(isset($data['inspection'][0]['inspection_type']) && $data['inspection'][0]['inspection_type']=='combined'?'selected':'')}} value="combined">Combined</option>
                                                        <option {{(isset($data['inspection'][0]['inspection_type']) && $data['inspection'][0]['inspection_type']=='special_drive'?'selected':'')}} value="special_drive">Special Drive</option>
                                                    </select>
                                                 </div>
                                            </div>
                                  
                                            
                                            <div class="col-lg-4 col-md-6 col-xs-12 hide-box ins-detail-sec"  >
                                                <div class="form-group">
                                                    <label>Members</label>
                                                    <input type="text" name="members" id="members" class="form-control"  value="{{old('members',$data['inspection'][0]['members'] ?? '')}}" {{$data['formType']=='show'?'disabled':''}} placeholder="Details">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-xs-12 hide-box ins-detail-sec" >
                                                <div class="form-group" id="vehicle_used_div">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-xs-12 hide-box vehicle-detail-sec" >
                                                <div class="form-group" id="vehicle_id_div"  >
                                                    ...
                                                    <select type="text" name="vehicle_id" id="vehicle_id" class="form-control" placeholder="vehicle no">
                                                        ...
                                                        <option value="{{$vehicle['id']}}"
                                                         ...
                                                         {{(isset($data['inspection'][0]['vehicle_id']) && $data['inspection'][0]['vehicle_id']==$vehicle['id'])?'selected':''}}>{{$vehicle['register_number']}}
                                            ...
                                            <div class="col-lg-4 col-md-6 col-xs-12 hide-box" id="others_spec_sec">
                                                <div class="form-group">
                                                    <label>Others Specify</label>
                                                    <input type="text" name="others_specify" id="others_specify" class="form-control"  value="{{old('others_specify',$data['inspection'][0]['others_specify'] ?? '')}}"  placeholder="Details">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="number_of_inspections" id="number_of_inspections" class="form-control"  value="{{old('number_of_inspections',$data['inspection'][0]['number_of_inspections'] ?? '')}}"  placeholder="No of case Booked">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-xs-12">
                                                <div class="form-group">
                                                    <label>Number of Case Booked</label>
                                                    <input type="text" name="number_of_case_inspected" id="number_of_case_inspected" class="form-control"  value="{{old('number_of_case_inspected',$data['inspection'][0]['number_of_case_inspected'] ?? '')}}"  placeholder="No of case Booked">
                                                </div>
                                            </div>
                                            <div class="col-xs-12">
                                                <div class="form-group">
...
<script>
     ...
     @if(isset($data['inspection'][0]['inspection_type']) && 
        ( $data['inspection'][0]['inspection_type']=='combined' || 
        $data['inspection'][0]['inspection_type']=='special_drive') )
        $('.ins-detail-sec').show();
    @else
        $('.ins-detail-sec').hide();
     @endif

     @if(isset($data['inspection'][0]['type_of_trade_inspected']) &&
      ( $data['inspection'][0]['type_of_trade_inspected']=='others') )
