            ...
            <div class="row">
                <div class="col-lg-12">
                     ...
                     @if(isset($data['formType']) && $data['formType']=='create')
                      <h3 class="page-header">MASTER DATA FIELD COMPALINT INSPECTIONS</h3>
                    @endif
                   @if(isset($data['formType']) && $data['formType']=='edit')
                      <h1 class="page-header">Edit Complaint Inspection</h1>
                    @endif
                    @if(isset($data['formType']) && $data['formType']=='show')
                      <h1 class="page-header"> Complaint Inspection Details</h1>
                    @endif
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                        <div class="panel-group">
                            <div class="panel panel-default">
                                ...
                                @if(isset($data['formType']) && $data['formType']=='create')
                                  <h5>Add New Complaint Inspection</h5p>
                                @endif
                                 @if(isset($data['formType']) && $data['formType']=='edit')
                                  <h5>Edit Complaint Inspection</h5p>
                                @endif
                                 @if(isset($data['formType']) && $data['formType']=='show')
                                  <h5>Complaint Inspection Details</h5p>
                                @endif
                                </div>
                                <div id="addnewuser" class="panel-collapse collapse in">
                                    ...
                                    <!-- end display form validation errors -->
                                         @if(isset($data['formType']) && $data['formType']=='create')
                                         <form role="form" action="{{route('md-fi-complaint-inspection.store')}}" id="userCreateForm" name="userCreateForm" method="POST" class="row">
                                          @csrf
                                         @endif
                                         @if(isset($data['formType']) && $data['formType']=='edit')
                                         <form role="form" action="{{route('md-fi-complaint-inspection.update',$data['inspection'][0]['id'])}}" id="userCreateForm" name="userCreateForm" method="POST" class="row">
                                        @method('PUT')
                                         @csrf
                                         @endif
                                         @if(isset($data['formType']) && $data['formType']=='show')
                                         ...
                                         @endif
                                            ...
                                            <div class="col-lg-4 col-md-6 col-xs-12">
                                                 <div class="form-group">
                                                    ...
                                                    <select type="text" name="compliance_type" id="compliance_type" class="form-control" placeholder="compliance type">
                                                        <option value="">Select Compliance Type </option>
                                                        <option {{(isset($data['inspection'][0]['compliance_type']) && $data['inspection'][0]['compliance_type']=='registration_of_packer_importer'?'selected':'')}} value="registration_of_packer_importer">Registration of Packer / Importer</option>
                                                        <option {{(isset($data['inspection'][0]['compliance_type']) && $data['inspection'][0]['compliance_type']=='license'?'selected':'')}} value="license">License</option>
                                                    </select>
                                                 </div>
                                            </div>
                                            @php
                                                $style  =   '';
                                            @endphp
                                            @if(isset($data['inspection'][0]['compliance_type']) && $data['inspection'][0]['compliance_type']=='registration_of_packer_importer')
                                                @php
                                                    $style  =   'style=display:block;';
                                                @endphp
                                            @endif
                                            <div class="col-lg-4 col-md-6 col-xs-12 hide-box" {{$style}} id="type_of_trade_inspected_sect">
                                                <div class="form-group">
                                            ...
                                            @php
                                                $style  =   '';
                                            @endphp
                                            @if(isset($data['inspection'][0]['compliance_type']) && $data['inspection'][0]['compliance_type']=='license')
                                                @php
                                                    $style  =   'style=display:block;';
                                                @endphp
                                            @endif
                                            <div class="col-lg-4 col-md-6 col-xs-12 hide-box" {{$style}} id="licence_type_sec">
                                                 <div class="form-group">
                                                    <label>License Type</label>
                                                    <select type="text" name="licence_type" id="licence_type" class="form-control" placeholder="licence type">
                                                        <option value=""> select license type </option>
                                                        <option {{(isset($data['inspection'][0]['licence_type']) && $data['inspection'][0]['licence_type']=='manufacturer'?'selected':'')}} value="manufacturer">Manufacturer</option>
                                                        <option {{(isset($data['inspection'][0]['licence_type']) && $data['inspection'][0]['licence_type']=='dealer'?'selected':'')}} value="dealer">Dealer</option>
                                                        <option {{(isset($data['inspection'][0]['licence_type']) && $data['inspection'][0]['licence_type']=='repairer'?'selected':'')}} value="repairer">Repairer</option>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-xs-12 hide-box vehicle-detail-sec" {{$style}}>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="place_visited" id="place_visited" class="form-control"  value="{{old('place_visited',$data['inspection'][0]['place_visited'] ?? '')}}" {{$data['formType']=='show'?'disabled':''}} placeholder="Place Visited">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-xs-12 hide-box vehicle-detail-sec" {{$style}}>
                                                 <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-xs-12">
                                                ...
                                                <label>License Fee</label>
                                                    <input type="text" name="licence_fee" id="licence_fee" class="form-control"  value="{{old('licence_fee',$data['inspection'][0]['licence_fee'] ?? '')}}" {{$data['formType']=='show'?'disabled':''}} placeholder="Fee Rs">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-xs-12">
                                                <div class="form-group">
...
<script>
    $('#compliance_type').change(function(e){
        if(this.value == 'license'){
            $('#licence_type_sec').show();
            $('#type_of_trade_inspected_sect').hide();
            $('#others_spec_sec').hide();
        }
        else{
            $('#type_of_trade_inspected_sect').show();
            $('#licence_type_sec').hide();
        }
    });
